...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$mt = $this->model_catalog_manufacturer->getManufacturer($product_info['manufacturer_id']);
			$this->data['manufacturer_text'] = html_entity_decode($mt['description'], ENT_QUOTES, 'UTF-8');
