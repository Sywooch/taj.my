...
<?if($_SESSION['TDM_ISADMIN']=="Y"){
	...
	<div class="admin_panel">
		<a href="/<?=TDM_ROOT_DIR?>/" class="apbut catalog" title="Каталог"> Каталог</a>
		...
		<a href="http://ibexshop.com.ua/upload/" class="apbut apr upload" title="Загрузка прайсов">Загрузка прайсов</a>
		<a href="/<?=TDM_ROOT_DIR?>/admin/import?multi=1/" class="apbut create_list" title="Загрузка прайсов">Мульти-обновление</a>
