...
class SimpleCheckout extends Simple {
    ...
    public function loadSimpleSession() {
        if ($this->request->server['REQUEST_METHOD'] == 'GET') {
            if (!empty($this->session->data['guest']['firstname']) && empty($this->session->data['simple']['customer']['firstname'])) {
                $this->session->data['simple']['customer']['firstname'] = $this->session->data['guest']['firstname'];
            }

            if (!empty($this->session->data['guest']['lastname']) && empty($this->session->data['simple']['customer']['lastname'])) {
                $this->session->data['simple']['customer']['lastname'] = $this->session->data['guest']['lastname'];
            }

            if (!empty($this->session->data['guest']['email']) && empty($this->session->data['simple']['customer']['email'])) {
                $this->session->data['simple']['customer']['email'] = $this->session->data['guest']['email'];
            }
            
            if (!empty($this->session->data['guest']['telephone']) && empty($this->session->data['simple']['customer']['telephone'])) {
                $this->session->data['simple']['customer']['telephone'] = $this->session->data['guest']['telephone'];
            }

            if (!empty($this->session->data['guest']['fax']) && empty($this->session->data['simple']['customer']['fax'])) {
                $this->session->data['simple']['customer']['fax'] = $this->session->data['guest']['fax'];
            }

            if (!empty($this->session->data['guest']['customer_group_id']) && empty($this->session->data['simple']['customer']['customer_group_id'])) {
                $this->session->data['simple']['customer']['customer_group_id'] = $this->session->data['guest']['customer_group_id'];
            }

            if (!empty($this->session->data['guest']['payment']['firstname']) && empty($this->session->data['simple']['payment_address']['firstname'])) {
                $this->session->data['simple']['payment_address']['firstname'] = $this->session->data['guest']['payment']['firstname'];
            }

            if (!empty($this->session->data['guest']['payment']['lastname']) && empty($this->session->data['simple']['payment_address']['lastname'])) {
                $this->session->data['simple']['payment_address']['lastname'] = $this->session->data['guest']['payment']['lastname'];
            }

            if (!empty($this->session->data['guest']['payment']['company_id']) && empty($this->session->data['simple']['payment_address']['company_id'])) {
                $this->session->data['simple']['payment_address']['company_id'] = $this->session->data['guest']['payment']['company_id'];
            }

            if (!empty($this->session->data['guest']['payment']['tax_id']) && empty($this->session->data['simple']['payment_address']['tax_id'])) {
                $this->session->data['simple']['payment_address']['tax_id'] = $this->session->data['guest']['payment']['tax_id'];
            }
            
            if (!empty($this->session->data['guest']['payment']['address_1']) && empty($this->session->data['simple']['payment_address']['address_1'])) {
                $this->session->data['simple']['payment_address']['address_1'] = $this->session->data['guest']['payment']['address_1'];
            }

            if (!empty($this->session->data['guest']['payment']['address_2']) && empty($this->session->data['simple']['payment_address']['address_2'])) {
                $this->session->data['simple']['payment_address']['address_2'] = $this->session->data['guest']['payment']['address_2'];
            }

            if (!empty($this->session->data['guest']['payment']['postcode']) && empty($this->session->data['simple']['payment_address']['postcode'])) {
                $this->session->data['simple']['payment_address']['postcode'] = $this->session->data['guest']['payment']['postcode'];
            }

            if (!empty($this->session->data['guest']['payment']['city']) && empty($this->session->data['simple']['payment_address']['city'])) {
                $this->session->data['simple']['payment_address']['city'] = $this->session->data['guest']['payment']['city'];
            }

            if (!empty($this->session->data['guest']['payment']['country_id']) && empty($this->session->data['simple']['payment_address']['country_id'])) {
                $this->session->data['simple']['payment_address']['country_id'] = $this->session->data['guest']['payment']['country_id'];
            }

            if (!empty($this->session->data['guest']['payment']['zone_id']) && empty($this->session->data['simple']['payment_address']['zone_id'])) {
                $this->session->data['simple']['payment_address']['zone_id'] = $this->session->data['guest']['payment']['zone_id'];
            }

            if (!empty($this->session->data['guest']['shipping']['firstname']) && empty($this->session->data['simple']['shipping_address']['firstname'])) {
                $this->session->data['simple']['shipping_address']['firstname'] = $this->session->data['guest']['shipping']['firstname'];
            }

            if (!empty($this->session->data['guest']['shipping']['lastname']) && empty($this->session->data['simple']['shipping_address']['lastname'])) {
                $this->session->data['simple']['shipping_address']['lastname'] = $this->session->data['guest']['shipping']['lastname'];
            }

            if (!empty($this->session->data['guest']['shipping']['company_id']) && empty($this->session->data['simple']['shipping_address']['company_id'])) {
                $this->session->data['simple']['shipping_address']['company_id'] = $this->session->data['guest']['shipping']['company_id'];
            }

            if (!empty($this->session->data['guest']['shipping']['tax_id']) && empty($this->session->data['simple']['shipping_address']['tax_id'])) {
                $this->session->data['simple']['shipping_address']['tax_id'] = $this->session->data['guest']['shipping']['tax_id'];
            }
            
            if (!empty($this->session->data['guest']['shipping']['address_1']) && empty($this->session->data['simple']['shipping_address']['address_1'])) {
                $this->session->data['simple']['shipping_address']['address_1'] = $this->session->data['guest']['shipping']['address_1'];
            }

            if (!empty($this->session->data['guest']['shipping']['address_2']) && empty($this->session->data['simple']['shipping_address']['address_2'])) {
                $this->session->data['simple']['shipping_address']['address_2'] = $this->session->data['guest']['shipping']['address_2'];
            }

            if (!empty($this->session->data['guest']['shipping']['postcode']) && empty($this->session->data['simple']['shipping_address']['postcode'])) {
                $this->session->data['simple']['shipping_address']['postcode'] = $this->session->data['guest']['shipping']['postcode'];
            }

            if (!empty($this->session->data['guest']['shipping']['city']) && empty($this->session->data['simple']['shipping_address']['city'])) {
                $this->session->data['simple']['shipping_address']['city'] = $this->session->data['guest']['shipping']['city'];
            }

            if (!empty($this->session->data['guest']['shipping']['country_id']) && empty($this->session->data['simple']['shipping_address']['country_id'])) {
                $this->session->data['simple']['shipping_address']['country_id'] = $this->session->data['guest']['shipping']['country_id'];
            }

            if (!empty($this->session->data['guest']['shipping']['zone_id']) && empty($this->session->data['simple']['shipping_address']['zone_id'])) {
                $this->session->data['simple']['shipping_address']['zone_id'] = $this->session->data['guest']['shipping']['zone_id'];
            }

            if (!empty($this->session->data['shipping_postcode']) && empty($this->session->data['simple']['shipping_address']['postcode'])) {
                $this->session->data['simple']['shipping_address']['postcode'] = $this->session->data['shipping_postcode'];
            }

            if (!empty($this->session->data['shipping_country_id']) && empty($this->session->data['simple']['shipping_address']['country_id'])) {
                $this->session->data['simple']['shipping_address']['country_id'] = $this->session->data['shipping_country_id'];
            }

            if (!empty($this->session->data['shipping_zone_id']) && empty($this->session->data['simple']['shipping_address']['zone_id'])) {
                $this->session->data['simple']['shipping_address']['zone_id'] = $this->session->data['shipping_zone_id'];
            }

            if (!empty($this->session->data['payment_postcode']) && empty($this->session->data['simple']['payment_address']['postcode'])) {
                $this->session->data['simple']['payment_address']['postcode'] = $this->session->data['payment_postcode'];
            }

            if (!empty($this->session->data['payment_country_id']) && empty($this->session->data['simple']['payment_address']['country_id'])) {
                $this->session->data['simple']['payment_address']['country_id'] = $this->session->data['payment_country_id'];
            }

            if (!empty($this->session->data['payment_zone_id']) && empty($this->session->data['simple']['payment_address']['zone_id'])) {
                $this->session->data['simple']['payment_address']['zone_id'] = $this->session->data['payment_zone_id'];
            }
        }
    }
