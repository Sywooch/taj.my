...
<?TDMShowBreadCumbs()?>
<hr style="width:86%;">
<div class="autopic subsection" title="<?=$arResult['MFA_MFC_CODE']?>" style="background:url(<?=$arResult['BRAND_LOGO_SRC']?>)"></div>
<?=TDMShowSEOText("TOP")?>
...
<?		foreach($arResult['SECTIONS'][$arResult['ROOT_SID']] as $arSec){
			...
			<div class="shead"><?if($arSec['URL']!=''){echo '<a href="'.$arResult['CSEC_LINK'].$arSec['URL'].'" >'.$arSec['NAME'].'</a>';}else{echo '&#9660; 555'.$arSec['NAME'];}?></div>
			<div class="sbody">
